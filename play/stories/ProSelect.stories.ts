...
/* 打包后引入方式（按需引入） */
// import { ProSelect } from 'component-library'

const meta: Meta = {
  title: 'Base Components/ProSelect',
  component: ProSelect,
  argTypes: {
    ...
    proSelectOptionRef: {
      ...
      table: {
        ...
        type: {
          summary: 'ProSelectOptionInstance[]',
        },
      },
    },
    ref: {
...
export const UseCase: StoryObj<typeof ProSelect> = {
  render: args => ({
    components: {
      ProSelect,
    },
